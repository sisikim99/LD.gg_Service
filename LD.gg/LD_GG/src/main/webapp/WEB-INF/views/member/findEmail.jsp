...
<!--FIND EMAIL CSS-->
<link rel="stylesheet" type="text/css"
	href="/resources/css/member/findEmail.css">
<!--FIND EMAIL JS-->
<script src="/resources/js/member/findEmail.js" defer></script>
</head>
<body>
	...
	<div class="main-container">
		<div class="email-find-container">
			<h3>이메일아이디 찾기</h3>
			<input class="input" type="text" id="phone" name="phone_num" placeholder="전화번호를 입력하세요"> .
